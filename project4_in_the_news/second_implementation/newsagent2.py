...
class NewsAgent:
    """
    An object that can distribute news items from news sources to news destinations.
    """
    def __init__(self):
        self.sources = []
        self.destinations = []
    ...
    def distribute(self):
        """
        Retrieve all news items from all sources, and Distributes them to all destinations.
        """
        items = []
...
class SimpleWebSource:
    """
    A news source that extracts news items from a web page using regular expressions.
    """
